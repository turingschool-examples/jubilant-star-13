...
RSpec.describe 'Doctors Show Page' do
  it 'displays the doctors attributes, the hospital associated and patients given' do
    ...
    doctor_patients_1 = DoctorPatients.create!(doctor_id: bailey.id, patient_id: geoff.id)
    doctor_patients_1 = DoctorPatients.create!(doctor_id: bailey.id, patient_id: sharina.id)
