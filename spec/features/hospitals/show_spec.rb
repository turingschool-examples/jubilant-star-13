...
RSpec.describe 'Hospital show page' do
  ...
  it 'can show all information about one hospital' do
    ...
    expect(page).to have_content('4 doctors')
    expect(page).to have_content("University 1, University 2, University 3,")
